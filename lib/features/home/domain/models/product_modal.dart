...
class ProductData {
  ...
  ProductData copyWith({String? parentId, bool? hasVariant}) => ProductData(
        id: id, name: name, unit: unit, unitValue: unitValue,
        brandId: brandId, tags: tags, sortOrder: sortOrder,
        description: description, quantity: quantity,
        categoryIds: categoryIds, subCategoryIds: subCategoryIds,
        isVegetarian: isVegetarian, pricePerUnit: pricePerUnit,
        businessPricePerUnit: businessPricePerUnit, type: type,
        flavor: flavor, ingredients: ingredients, keyFeatures: keyFeatures,
        shelfLife: shelfLife, manufacturerDetails: manufacturerDetails,
        countryOfOrigin: countryOfOrigin, fssaiLicense: fssaiLicense,
        keyword: keyword, customerCareDetails: customerCareDetails,
        returnPolicy: returnPolicy, expiryDate: expiryDate,
        seller: seller, sellerFssai: sellerFssai, disclaimer: disclaimer,
        discount: discount, sku: sku,
        productShownToNormalCustomer: productShownToNormalCustomer,
        images: images, warehouseIds: warehouseIds, packs: packs,
        productShownToBusinessCustomer: productShownToBusinessCustomer,
        productCode: productCode, permalink: permalink,
        packagingtype: packagingtype, storageTips: storageTips,
        nutrientValue: nutrientValue, storageTemperature: storageTemperature,
        marketedBy: marketedBy, quantityAlert: quantityAlert,
        status: status, businessDiscount: businessDiscount,
        ...
        isVatAdded: isVatAdded, isFeatured: isFeatured,
        featuredImages: featuredImages, relatedProducts: relatedProducts,
        hasVariant: hasVariant ?? this.hasVariant,
        parentId: parentId ?? this.parentId,
        slug: slug, createdAt: createdAt, updatedAt: updatedAt,
      );
